...
@Component
public class CreateExhibitorHandler implements Handler<CreateExhibitorRequest, Ticket> {
  ...
  @Override
  public ResponseEntity<Ticket> handle(final CreateExhibitorRequest request) {
    ...
    final Exhibitor exhibitor = new Exhibitor(company, fair, request.createdBy());
